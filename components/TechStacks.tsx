...
const TechCard = ({ tech, index }: { tech: any, index: number }) => (
    <div
        key={index}
        className="flex items-center space-x-2 bg-gray-100 dark:bg-gray-800 px-2 py-2 rounded-xl shadow-sm transition-transform duration-300 hover:scale-105 w-52 mr-2 sm:w-52"
    >
