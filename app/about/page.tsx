                ...
                <div className="grid grid-cols-1 md:grid-cols-[3fr_1fr] gap-12">
                    <div className="w-full">
                        ...
                        <blockquote className="relative border-l-4 border-gray-400 dark:border-gray-600 pl-6 italic text-lg text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 p-4 rounded-lg shadow-sm">
                            <span className="absolute -top-3 left-2 text-4xl text-gray-400 dark:text-gray-600">
                                “
                            </span>
                            Good artists borrow, great artists steal.
                            <span className="absolute -bottom-3 right-2 text-4xl text-gray-400 dark:text-gray-600">
                                ”
                            </span>
                        </blockquote>
                    </div>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="text-sm text-gray-500 mb-6">
                            Carousel images are from my school days and current college days, capturing moments that shaped my journey.
                        </p>
