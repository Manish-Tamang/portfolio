  ...
  return (
    <div className="container mx-auto py-12 px-6 max-w-3xl">
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Built with Sanity, MDX, Firebase, TypeScript, NextJS and PostgreSQL,
          ...
          <div className="flex flex-col items-center py-8 px-6 bg-neutral-50 dark:bg-neutral-900/50 rounded-lg">
            ...
            <div className="flex items-baseline gap-3">
              <CountUp
                from={0}
                to={Math.floor((new Date().getTime() - new Date('2023-04-12').getTime()) / (1000 * 60 * 60 * 24))}
                separator=","
                direction="up"
                duration={1}
      ...
      <section className="mb-8">
        ...
        <div className="my-8">
          <div className="grid grid-cols-4 border-l border-t border-gray-200 dark:border-neutral-800">
            <IconItem
              url="https://nextjs.org/"
              icon={
                <SiNextdotjs size={32} className="text-black dark:text-white" />
              }
            />
            <IconItem
        ...
        <p className="text-gray-700 dark:text-gray-300 mt-4">
          ...
          <span className="font-medium">manishtamang.com</span> for this site
          from{" "}
          <Link
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          A carefully selected set of typefaces contributes to the
          website&apos;s visual identity:
        </p>
        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 mb-4">
          <li>
            <b>Karla:</b> Used for the majority of the body content for
            readability.
          </li>
          <li>
            <b>Geist:</b> Used for the content of Blogs and Projects Slug Page.
          </li>
          <li>
            <b>Peachi:</b> Applied to headings to create a distinct and
            memorable visual hierarchy.
          </li>
          <li>
            <b>Life of Apple:</b> Elegantly displays my name, lending a personal
            touch.
          </li>
          <li>
            <b>MonoLisa:</b> Chosen for code snippets, ensuring clarity and
            legibility.
          </li>
          <li>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          The website&apos;s color palette is a result of deliberate selection
          and feedback, reflecting my personal aesthetic while prioritizing
          accessibility and a modern feel.
        </p>
        <ColorPalette />
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
          These colors are consistently applied throughout the site to maintain
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          This website leverages several external APIs and libraries to enhance
        ...
        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300">
          ...
          <li>
            ...
            : To dynamically display weather information.
          </li>
          <li>
            <Link
          ...
          <li>
            ...
            : To display time in the contact page.
          </li>
          <li>
            <Link
              href="https://umami.is/"
            ...
            : For privacy-focused website analytics.
          </li>
          <li>
            <Link
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          Beyond the core tech stack, the website utilizes the following
          libraries to enhance specific features:
        </p>
        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300">
          <li>
            <Link
          ...
          <li>
            ...
            : Used for data visualization in the dashboard.
          </li>
          <li>
            <Link
          ...
          <li>
            ...
            : To generate engaging confetti effects.
          </li>
          <li>
            <Link
            ...
            : For unique and personalized custom cursors.
          </li>
          <li>
            <Link
            ...
            : Enables image zooming functionality.
          </li>
          <li>
            <Link
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300">
          <li>
            ...
            : For the inspiration to re-create my new portfolio.
          </li>
          <li>
            <Link
        ...
        <p className="text-gray-700 dark:text-gray-300 mt-4">
          And to many more talented developers and designers whose work has
          unknowingly shaped my perspective and approach. Thank you all.
        </p>
      </section>

      <p className="text-xs text-gray-500 dark:text-gray-400 mt-8">
        This page is inspired by{" "}
        <a href="https://jahir.dev/colophon" className="underline">
          Jahir Fiquitiva
        </a>
        .
      </p>
...
const TypographyItem: React.FC<{ label: string; font?: string }> = ({
  label,
  font,
}) => (
  <div
    className="border p-4 text-4xl text-center"
