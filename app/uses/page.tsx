  ...
  return (
    ...
    >
      ...
      <Image
        ...
        width={600}
        height={400}
        className="rounded-[12px] mb-4 w-max shadow-md"
      />
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <a href="https://sayandey.dev/utilities" className="underline">
          Sayan Dey
        </a>
        .
      </motion.p>
      ...
      >
        Last Update: <span className="font-bold">15 October 2025</span>
      </motion.p>
    </motion.div>
  );
};
